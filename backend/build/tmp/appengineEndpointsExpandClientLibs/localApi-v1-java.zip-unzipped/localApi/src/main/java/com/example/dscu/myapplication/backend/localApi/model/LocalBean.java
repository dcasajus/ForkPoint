...
public final class LocalBean extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<java.lang.String> comentaris;
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<java.lang.String> getComentaris() {
    return comentaris;
  }

  /**
   * @param comentaris comentaris or {@code null} for none
   */
  public LocalBean setComentaris(java.util.List<java.lang.String> comentaris) {
